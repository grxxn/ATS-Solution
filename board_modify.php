...
<body id="guideForm">
    ...
    <section class="form_container">
        ...
        <form action="./board_modify_ok.php?num=<?php echo $num ?>" method="post" class="board_form" enctype="multipart/form-data">
            <label>
                작성자
            ...
            <label class="board_title">
                제목
                <input type="text" name="boardTitle" value="<?php echo $info['title']; ?>" required>
            </label>
            <label>
                <textarea name="boardContent" id="board_area" cols="30" rows="10" required spellcheck="false"><?php echo $info['content']; ?></textarea>
            </label>
