    ...
    <section class="contents">
        <div class="contents_container">
            ...
            <div class="main_content">
                ...
                <form name="inquiryForm" class="inquiry_form" action="./inquiry_ok.php" method="post" enctype="multipart/form-data">
                    ...
                    <label class="inquiry_title">
                        ...
                        <div class="inquiry_title_grp">
                            ...
                            <input type="text" name="userTitle" id="titleInput" required>
                        </div>
                    </label>
                    <label>
                        작성자 *
                    ...
                    <label>
                        연락처
                        <input type="tel" name="userTel" placeholder="- 생략 (숫자로만 작성)">
                    </label>
                    <label>
                        회사명
                        <input type="text" name="userCompany" placeholder="(개인일 경우 이름 작성)">
                    </label>
                    <label>
                        회사주소 (지역)
                        <input type="text" name="userCompanyAddr">
                    </label>
                    <label>
                        문의내용
                        <textarea name="inquiry" id="inquiry" cols="30" rows="10" required wrap='hard' spellcheck="false"></textarea>
                    </label>
                    <label class='inquiry_lock'>
                        <input type="checkbox" name='lockpost' value='1'>
                        비밀 글로 작성하겠습니다.
                    </label>
                    <div class="submitGrp">
