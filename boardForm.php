...
<head>
    ...
    <link rel="stylesheet" href="./CSS/styles.css?var=0">
...
<body id="guideForm">
    ...
    <section class="form_container">
        <form action="./board_ok.php" method="post" class="board_form" enctype="multipart/form-data">
            <label>
                작성자
            ...
            <label>
                <textarea name="boardContent" id="board_area" cols="30" rows="10" required wrap='hard' spellcheck="false"></textarea>
            </label>
