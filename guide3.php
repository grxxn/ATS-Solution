            ...
            <div class="main_content">
                ...
                <div class="guide_content">
                    <table class="board">
                        ...
                        $sql = "SELECT * FROM board ORDER BY num DESC LIMIT ".$pageSql.", ".$rowPerPage." ";
                        ...
                        while ($info=mysqli_fetch_array($rs)) {
                            ...
                            <tr class='board_info'>
                                ...
                                <td class='board_read_title'>
                                    <a href='./board_view.php?num=<?php echo $info['num'] ?>'>
                                        <?php echo $info['title'] ?>
                                    </a>
                    ...
                    <div class="paging">
                        ...
                        if($block <= 1) {
                            ...
                            echo "<span><a href='guide3.php?page=".($b_start_page-1)."&list=".$listNum."'>
                            <
                            </a></span>";
                        }
                        // 숫자 페이징
                        for($j = $b_start_page; $j <= $b_end_page; $j++){
                            if($pageNum == $j) { // 현재 페이지 
                                ...
                                echo "<span><a href='guide3.php?page=".$j."&list=".$listNum."' class='pageNum'>
                                ".$j."
                                </a></span>";
                            }
                        }
                        ...
                        if($block >= $total_block) { // block과 총 block갯수의 값이 같다면
                            ...
                            echo "<span><a href='guide3.php?page=".($b_end_page+1)."&list=".$listNum."'>
                            > 
                            </a></span>";
                        }
                        ?>        
                    </div>
                    <button type="button" class="write_btn" onclick="location.href='boardForm.php'">
                        글쓰기
                    </button>
                </div>
            </div>
